...
*$ontext
         accounting_costs =sum((COf,cv,ash,sulf,tr,Els,t,rco,rrco)$rail(tr),
         COtrans.l(COf,cv,ash,sulf,tr,Els,t,rco,rrco)*(RailSurcharge)*COtransD(tr,rco,rrco))
         +sum((tr,t,rco,rrco)$rail(tr),
         COtransbld.l(tr,t,rco,rrco)*COtransconstcst(tr,t,rco,rrco)*COtransD(tr,rco,rrco));
...
*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         ...
         accounting_costs = accounting_costs-sum((tr,t,rco,rrco)$rail(tr),
         COtransbld.l(tr,t,rco,rrco)*COtransconstcst(tr,t,rco,rrco)*COtransD(tr,rco,rrco));
...
*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
         ...
         elasticity(demand_change,COf,trun,'coal_price') =  sum((r,ash,sulf)$(COdem.m(COf,ash,sulf,'summ',trun,r)>0),COdem.m(COf,ash,sulf,'summ',trun,r)*OTHERcoconsump(COf,trun,r)/sum(rr,OTHERCOconsump(COf,trun,rr)));
