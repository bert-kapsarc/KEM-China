...
parameter
         ...
         ELnoxexist(ELpd,v,size,chp,Rall) nox existing capacity in GW
         ELfgdexist(ELpd,v,size,chp,Rall) fgd existing capacity in GW
...
ELfgdexist(Elpd,v,size,chp,r) = sum(GB$regions(r,GB),ELfgdexist(Elpd,v,size,chp,GB));
ELnoxexist(Elpd,v,size,chp,r) = sum(GB$regions(r,GB),ELnoxexist(Elpd,v,size,chp,GB));
...
*        (lg, ROR, sto) given by the IHS midstream database
         ELhydexistcp.up('hydrolg',v,trun,r)$(ord(trun)=1 and vo(v))=
          ELhydexistcp.l('hydrolg',v,trun,r)
         +ELhydroCEIC(r)
         -sum(ELphyd,ELhydexistcp.l(ELphyd,v,trun,r));
...
*         ELwindexistcp.fx('windon','old',trun,r)$(ord(trun)=1)=ELexist('windon','no_chp',r)+ELexist('windoff','no_chp',r);
         ...
         ELfgcexistcp.fx(ELpd,v,DeSOx,trun,r)$(ord(trun)=1)=
                 sum((chp,size),ELfgdexist(ELpd,v,size,chp,r))
;
         ELfgcexistcp.fx(ELpd,v,DeNOx,trun,r)$(ord(trun)=1)=
                 sum((chp,size),ELnoxexist(ELpd,v,size,chp,r))
;
...
*$ontext
         ...
         ELprofitcoal(v,trun,r) regional Profit constraint aggregation of all coal power plants
...
*         DELtop(ELpd,v,ELf,fss,trun,r)     dual from ELtop
         ...
         DELslack(Elp,v,trun,r)
         DELslackcoal(v,trun,r)
...
*  +sum((Elpd,v,ELl,ELf,fss,cv,sulf,sox,nox,t,r)$ELpELf(ELpd,ELf,fss,cv,sulf,sox,nox),
  +sum((v,t,r),ELslackcoal(v,t,r))
  +Sum((ELp,v,t,r)$(not ELpcoal(Elp)),ELslack(ELp,v,t,r))
...
ELprofitcoal(v,t,r)$(ELptariffcoal(v))..


+ELslackcoal(v,t,r)


+sum(Elp$(ELptariff(ELp,v) and Elpcoal(ELp)),
  ...
  -1*( ELbld(Elp,v,t-ELleadtime(Elp),r)
*      +ELrsrvbld(ELp,v,t-ELleadtime(Elp),r)
     )*ELpfixedcost(ELp,v,t,r)$vn(v)

  -1*Elexistcp(ELp,v,t,r)*ELpsunkcost(ELp,v,t,r)

  -sum((sox)$DeSOx(sox),(
         ELfgcexistcp(ELp,v,sox,t,r)+ELfgcbld(ELp,v,sox,t-ELfgcleadtime(sox),r))*EMfgccapexD(sox,t)
  )
...
DELslack(Elp,v,t,r)$(not ELpcoal(Elp) and ELptariff(ELp,v))..
         1
         =g= DELprofit(ELp,v,t,r);

DELslackcoal(v,t,r)$(ELptariffcoal(v))..
         1
         =g= DELprofitcoal(v,t,r)
;
...
DELexistcp(ELpd,v,t,r)..
  ...
  -DELprofitcoal(v,t,r)*ELpsunkcost(ELpd,v,t,r)$(ELptariff(ELpd,v) and ELpcoal(ELpd))
...
*  sum(ELppd,ELcapadd(Elpd,ELppd)*ELpfixedcost(ELppd,v,t,r)*ELdiscfact(t))
  ...
  -DELprofitcoal(v,t+ELleadtime(ELpd),r)*ELpfixedcost(ELpd,v,t,r)$(ELptariff(ELpd,v) and ELpcoal(ELpd))
...
DELrsrvbld(ELpd,v,t,r)$vn(v).. 0 =g=
  ...
  -DELprofitcoal(v,t,r)*ELpfixedcost(ELpd,v,t,r)$(ELptariff(ELpd,v) and ELpcoal(ELpd))
;
...
*  -DELprofit(ELpd,v,t,r)*ELfuelburn(Elpd,v,ELf,cv,r)*
  -(DELprofitcoal(v,t,r)*ELfuelburn(Elpd,v,ELf,cv,r)*
   (DCOdem(ELf,cv,sulf,'summ',t,r)
         -sum(rco$(rco_dem(rco,r) and not r(rco) and rcodem(rco)),
       DCOsuplim(ELf,cv,sulf,'summ',t,rco)*Elsnorm('summ')/num_nodes_reg(r))
...
DELoploc(ELpd,v,ELl,ELf,fss,cv,sulf,sox,nox,t,r)$(not ELpnuc(ELpd) and
  ...
  +ELpsunkcost(ELpd,v,t,r)*DELprofitcoal(v,t,r)$(ELpcoal(Elpd) and ELptariff(ELpd,v))
...
DELwindop(ELpw,v,ELl,t,r)..
  ...
  +(DELTA2(Elpw,v,t,r)*DELProfit(ELpw,v,t,r))$ELptariff(ELpw,v)
...
*  -EMfgccapexD(fgc,t)*DELprofit(ELpd,v,t,r)$ELptariff(ELpd,v)
  -EMfgccapexD(fgc,t)*DELprofitcoal(v,t,r)$ELptariff(ELpd,v)
...
*  -EMfgccapexD(fgc,t)*DELprofit(ELpd,v,t+ELfgcleadtime(fgc),r)$ELptariff(ELpd,v)
  -EMfgccapexD(fgc,t)*DELprofitcoal(v,t+ELfgcleadtime(fgc),r)$ELptariff(ELpd,v)
...
DELslack.ELslack,DELslackcoal.ELslackcoal,
